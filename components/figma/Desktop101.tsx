...
import svgPaths from "@/lib/figma/svg-p6e5v9seca";
...
const imgImage831 = "/assets/figma/5799e88e6e7646ac2ae2188e67421a0b79a5720f.png";
...
const imgImage = "/assets/figma/da5387af3c52ae0b4f22547f193282c932bf43bf.png";
import { imgImage834 } from "@/lib/figma/svg-i4x8e";

function MaskGroup() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%+40.5px)] top-[215px]" data-name="Mask group">
      <div className="-translate-x-1/2 absolute h-[817px] left-[calc(50%+40.5px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-2px] mask-size-[1613px_819px] opacity-46 rounded-[26px] top-[217px] w-[1613px]" style={{ maskImage: `url("${imgImage834}")` }} data-name="image 834">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[26px]">
          <img alt="" className="absolute h-[100.24%] left-[-2.63%] max-w-none top-[-0.24%] w-[105.25%]" src={imgImage835} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute left-[1718.98px] size-[37.535px] top-[136px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.5354 37.5354">
        <g id="Group 40">
          <circle cx="18.7677" cy="18.7677" id="Ellipse 1" r="13.7389" stroke="url(#paint0_linear_1_367)" strokeMiterlimit="3.99393" strokeWidth="3.19991" transform="rotate(30 18.7677 18.7677)" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_367" x1="26.7215" x2="18.7677" y1="7.84887" y2="32.5066">
  ...
  return (
    <div className="absolute left-[555px] size-[26px] top-[25px]" data-name="noto:fire">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="noto:fire">
          <path d={svgPaths.pc62aa80} fill="url(#paint0_radial_1_325)" id="Vector" />
          <path d={svgPaths.p1af75280} fill="url(#paint1_radial_1_325)" id="Vector_2" />
        </g>
        <defs>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(-14.338 -0.0622268 -0.10223 23.5258 12.6373 25.2486)" gradientUnits="userSpaceOnUse" id="paint0_radial_1_325" r="1">
            <stop offset="0.314" stopColor="#FF9800" />
            <stop offset="0.662" stopColor="#FF6D00" />
            <stop offset="0.972" stopColor="#F44336" />
          </radialGradient>
          <radialGradient cx="0" cy="0" gradientTransform="matrix(-0.151528 15.0013 11.2896 0.114021 13.4429 10.9806)" gradientUnits="userSpaceOnUse" id="paint1_radial_1_325" r="1">
...
function IconoirFacebook() {
  return (
    <div className="absolute left-[365.12px] size-[22.722px] top-[812.96px]" data-name="iconoir:facebook">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.7222 22.7222">
        <g id="iconoir:facebook">
          <path d={svgPaths.p333ff000} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13609" />
        </g>
      </svg>
    </div>
  );
...
function StreamlineLinkedin() {
  return (
    <div className="absolute left-[482.88px] size-[18.178px] top-[814.85px]" data-name="streamline:linkedin">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.1778 18.1778">
        <g clipPath="url(#clip0_1_337)" id="streamline:linkedin">
          <path d={svgPaths.p32d63300} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.991495" />
        </g>
        <defs>
          <clipPath id="clip0_1_337">
            <rect fill="white" height="18.1778" width="18.1778" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Group() {
  return (
    <div className="absolute inset-[14.58%_14.59%_14.58%_14.58%]" data-name="Group">
      <div className="absolute inset-[-3.53%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.6669 18.6669">
          <g id="Group">
            <path d={svgPaths.p2e6f7300} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.23076" />
            <path d={svgPaths.p3534eef2} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.23076" />
            <path d={svgPaths.p6f4e568} fill="var(--fill-0, black)" id="Vector_3" />
          </g>
        </svg>
      </div>
    </div>
...
function ProiconsInstagram() {
  return (
    <div className="absolute left-[537.42px] overflow-clip size-[24.616px] top-[812.01px]" data-name="proicons:instagram">
      <Group />
    </div>
  );
}

function ProiconsXTwitter() {
  return (
    <div className="absolute left-[307.36px] size-[22.722px] top-[812.96px]" data-name="proicons:x-twitter">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.7222 22.7222">
        <g id="proicons:x-twitter">
          <path d={svgPaths.p2939c900} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.13609" />
        </g>
      </svg>
    </div>
  );
...
function PhDribbbleLogoLight() {
  return (
    <div className="absolute left-[420.97px] size-[26.506px] top-[811.44px]" data-name="ph:dribbble-logo-light">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.5063 26.5063">
        <g id="ph:dribbble-logo-light">
          <path d={svgPaths.p11788300} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function HeroiconsCubeTransparent20Solid() {
  return (
    <div className="absolute left-[178px] size-[36px] top-[1487px]" data-name="heroicons:cube-transparent-20-solid">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="heroicons:cube-transparent-20-solid">
          <path clipRule="evenodd" d={svgPaths.p2fbef780} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IcOutlinePrivacyTip() {
  return (
    <div className="absolute left-[611px] size-[36px] top-[1487px]" data-name="ic:outline-privacy-tip">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
...
function FlowbiteUsersGroupOutline() {
  return (
    <div className="absolute left-[1040px] size-[42px] top-[1484px]" data-name="flowbite:users-group-outline">
...
function IconoirDesignPencil() {
  return (
    <div className="absolute left-[1475px] overflow-clip size-[38px] top-[1486px]" data-name="iconoir:design-pencil">
      <Group1 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute h-[544px] left-[52px] top-[2252px] w-[1799px]">
      ...
      <div className="absolute h-[26.137px] left-[248px] top-[176px] w-[31.046px]" data-name="image 835">
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop - 101">
      <MaskGroup />
      <div className="absolute flex h-[685.947px] items-center justify-center left-[-77px] top-[1812.44px] w-[878.635px]">
      ...
      <div className="absolute flex h-[510.579px] items-center justify-center left-[1253px] top-[1041px] w-[779.378px]">
        <div className="-scale-y-100 flex-none rotate-[179.52deg]">
          <div className="h-[504.066px] relative w-[775.159px]">
            <div className="absolute inset-[-6.15%_-4%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 837.16 566.07">
                <path d={svgPaths.p3ed2c380} id="Vector 542" opacity="0.32" stroke="url(#paint0_linear_1_365)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="62" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_365" x1="52.5655" x2="640.419" y1="41.8527" y2="477.748">
                    <stop stopColor="#D08E8F" stopOpacity="0" />
                    <stop offset="0.408654" stopColor="#D08E8F" />
                    <stop offset="1" stopColor="#D08E8F" stopOpacity="0" />
                  </linearGradient>
      ...
      <div className="-translate-x-1/2 absolute bg-gradient-to-b from-[#f5f5f5] h-[448px] left-1/2 opacity-20 rounded-[25px] to-[#e8e8e8] top-[1364px] w-[1920px]" />
      <div className="-translate-x-1/2 absolute bg-white h-[106px] left-[calc(50%+3px)] opacity-62 rounded-[22px] shadow-[0px_4px_62.6px_0px_rgba(0,0,0,0.1)] top-[102px] w-[1674px]" />
      ...
      <div className="-translate-x-1/2 absolute h-[82px] left-[calc(50%+21.5px)] top-[977px] w-[1877px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1877 82">
          <path d={svgPaths.p3e3d2340} fill="url(#paint0_linear_1_363)" id="Vector 500" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_363" x1="1019.7" x2="1019.7" y1="140.176" y2="-4.7898e-06">
      ...
      <div className="-translate-x-1/2 absolute flex h-[730px] items-center justify-center left-[calc(50%+21px)] top-[247px] w-[1572px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[730px] relative w-[1572px]">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1572 730">
              <path d="M0 730V0H1572V730L0 730Z" fill="url(#paint0_linear_1_353)" id="Vector 501" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_353" x1="867.673" x2="867.673" y1="429" y2="-2.57752e-05">
                  <stop stopColor="white" stopOpacity="0" />
      ...
      <div className="-translate-x-1/2 absolute h-[407px] left-[calc(50%+0.5px)] pointer-events-none rounded-tl-[162.487px] rounded-tr-[162.487px] top-[610px] w-[325px]">
        <div aria-hidden className="absolute bg-white inset-0 rounded-tl-[162.487px] rounded-tr-[162.487px]" />
        <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0px_33.085px_18.047px_0px_rgba(0,0,0,0.2)]" />
      </div>
      <div className="absolute h-0 left-[296.48px] top-[708.72px] w-[320px]">
        <div className="absolute inset-[-0.47px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 320 0.94674">
            <path d="M0 0.47337H320" id="Vector 9" stroke="var(--stroke-0, #CCCCCC)" strokeWidth="0.94674" />
          </svg>
        </div>
      </div>
      <div className="absolute h-0 left-[296.48px] top-[765.72px] w-[320px]">
        <div className="absolute inset-[-0.47px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 320 0.94674">
            <path d="M0 0.47337H320" id="Vector 9" stroke="var(--stroke-0, #CCCCCC)" strokeWidth="0.94674" />
          </svg>
      ...
      <div className="-translate-x-1/2 absolute h-[59.063px] left-[calc(50%-15.97px)] top-[981.94px] w-[752.065px]">
        <div className="absolute inset-[-37.76%_-2.97%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 796.665 103.663">
            <g filter="url(#filter0_f_1_335)" id="Vector 492">
              <path d={svgPaths.p2655e400} fill="var(--fill-0, black)" fillOpacity="0.23" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="103.663" id="filter0_f_1_335" width="796.665" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_1_335" stdDeviation="11.15" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute h-[494.722px] left-[calc(50%-15.52px)] top-[544px] w-[700.958px]" data-name="ChatGPT Image May 23, 2025, 04_34_40 PM-Photoroom">
      ...
      <div className="-translate-x-1/2 absolute bg-white h-[296.847px] left-[calc(50%-631.85px)] rounded-[20.66px] shadow-[0px_64px_87.754px_0px_rgba(0,0,0,0.1)] top-[1441.45px] w-[400.294px]" />
      ...
      <div className="absolute h-[375.154px] left-[653.96px] top-[574.64px] w-[579.564px]" data-name="image 831">
      ...
      <IconoirDesignPencil />
      <div className="absolute flex h-[573.983px] items-center justify-center left-[1478px] top-[1771px] w-[558.671px]">
        <div className="-scale-y-100 flex-none rotate-[141.66deg]">
          <div className="h-[449.857px] opacity-24 relative w-[356.491px]" data-name="telegram-cloud-document-4-5814283686010428407 1">
      ...
      <Frame1 />
      <div className="absolute flex h-[465.532px] items-center justify-center left-[-34px] top-[1122px] w-[488.381px]">
        <div className="-scale-y-100 flex-none rotate-[-162.73deg]">
          <div className="h-[363.663px] relative w-[398.384px]" data-name="image 836">
            <img alt="" className="absolute inset-0 max-w-none object-bottom pointer-events-none size-full" src={imgImage837} />
          </div>
        </div>
      </div>
      <div className="absolute h-[26.137px] left-[164.46px] top-[142.86px] w-[31.046px]" data-name="image 835">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[290.86%] left-[-73.08%] max-w-none top-[-95.94%] w-[244.87%]" src={imgImage836} />
        </div>
      </div>
      <div className="absolute h-[379px] left-[653px] rounded-tl-[7.733px] rounded-tr-[7.733px] top-[575px] w-[581px]" data-name="image">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-tl-[7.733px] rounded-tr-[7.733px] size-full" src={imgImage} />
      </div>
    </div>
  );
}