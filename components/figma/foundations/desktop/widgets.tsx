...
import { imgImage836, imgTelegramCloudDocument458142836860104283981, imgTelegramCloudDocument458142836860104284073, imgTelegramCloudDocument458142836860104284074, svgPaths } from "./assets";
...
export function ProiconsInstagram() {
  return (
...
export function IconoirDesignPencil() {
  return (
